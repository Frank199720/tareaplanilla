...
def registrarMovimiento():
  ...
  try:
    cursor = connection.cursor()
    idfecha = request.form['fecha'] 
    idfecha=idfecha.strip()
    idtrabajador = request.form['trabajador'] 
    idtrabajador=idtrabajador.strip()
    idconcepto = request.form['concepto'] 
    idconcepto=idconcepto.strip()
    monto=request.form['monto']
    QUERY_AFTER= "SELECT * FROM movimientomes where idtrabajador = '"+idtrabajador+"' and idconcepto= '"+idconcepto+"' and idmes= '"+idfecha+"'"
    cursor.execute(QUERY_AFTER)
